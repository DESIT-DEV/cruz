...
<div class="panel-body" style="height: 400px;" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    ...
    <div class="form-group col-lg-2 col-md-2 col-xs-6">
      <label for="">Iva: </label>
      <input class="form-control"  type="text" name="impuesto" value="0.13" id="impuesto">
    </div>
...
<div class="form-group col-lg-12 col-md-12 col-xs-12">
     <table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
       ...
       <tfoot>
         ...
         <th><h4>Descripcion<br>
          <textarea name="descripcion" style="width : 150px; heigth : 10px"  id="descripcion" cols="30"></textarea></h4></th>
        <th><h4>T/.<input type="text" style="width : 60px; heigth : 10px" name="total_venta" value="0.00" id="total_venta"></h4></th>
...
require 'footer.php';
 ?>
 <script src="scripts/venta6.js"></script>
 <?php 
}
