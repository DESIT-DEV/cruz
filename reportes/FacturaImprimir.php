...
// Company
function addSociete( $nom, $adresse/*$logo,$ext_logo si hubiera un lOgo*/)
{
    $x1 = 10;
    $y1 = 4;
...
function fact_dev(  )
{
    ...
    //$this->RoundedRect($r1, $y1, ($r2 - $r1), $y2+15, 2.5, 'DF');
    $this->SetXY( $r1+1, $y1+2);
   
    $this->Cell($r2-$r1 -1,5, $texte, 0, 1, "C" );
...
function addDate( $date )
{
    ...
    $y2  = $y1 ;
    $mid = $y1 + ($y2 / 2);
   // $this->RoundedRect($r1, $y1, ($r2 - $r1), $y2, 3.5, 'D'); para hcer un redondo 
    //$this->Line( $r1, $mid, $r2, $mid);
    $this->SetXY( $r1 -1, $y1+18 );
    $this->SetFont( "Arial", "B", 10);
   // $this->Cell(10,5, "Fecha:", 0, 0, "L");
    $this->SetXY( $r1-25, $y1+12 );
    $this->SetFont( "Arial", "", 10);
    $this->Cell(10,5,$date, 0,0, "C");
}

function addGiro( $giro )
{
    $r1  = $this->w - 80;
    $r2  = $r1 + 68;
    $y1  = 25;
   ...
   // $this->RoundedRect($r1, $y1, ($r2 - $r1), $y2, 3.5, 'D'); para hcer un redondo 
    ...
    $this->SetFont( "Arial", "B", 10);
   // $this->Cell(10,5, "Fecha:", 0, 0, "L");
    $this->SetXY( $r1-25, $y1+38 );
    $this->SetFont( "Arial", "", 10);
    $this->Cell(10,5,$giro, 0,0, "C");
}

function addNrf( $num_documento2 )
{
    $r1  = $this->w - 80;
    $r2  = $r1 + 68;
    $y1  = 25;
   ...
   // $this->RoundedRect($r1, $y1, ($r2 - $r1), $y2, 3.5, 'D'); para hcer un redondo 
    ...
    $this->SetFont( "Arial", "B", 10);
   // $this->Cell(10,5, "Fecha:", 0, 0, "L");
    $this->SetXY( $r1-25, $y1+32);
    $this->SetFont( "Arial", "", 10);
    $this->Cell(10,5,$num_documento2, 0,0, "C");
}
...
function addDepartamento( $Departamento )
{
   ...
   // $this->RoundedRect($r1, $y1, ($r2 - $r1), $y2, 3.5, 'D'); para hcer un redondo 
    ...
    $this->SetFont( "Arial", "B", 10);
   // $this->Cell(10,5, "Fecha:", 0, 0, "L");
    $this->SetXY( $r1-95, $y1+38 );
    $this->SetFont( "Arial", "", 10);
    $this->Cell(10,5,$Departamento, 0,0, "C");
}
...
function addCadreTVAs($letras)
{
   ...
   // $this->Line( $r1, $y1+4, $r2, $y1+4);
    $this->SetXY( $r1+9, $y1-100);
    $this->Cell(10,4, "");
    $this->SetFont( "Arial", "", 10);
    $this->SetXY( $r1+10, $y2-113 );
